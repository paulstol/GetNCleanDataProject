tidySamsung <- function() {
     ...
     names(meanAndStdDevData) <- gsub("fBody", "FrequencyBody", names(meanAndStdDevData))
     names(meanAndStdDevData) <- gsub("fGravity", "FrequencyGravity", names(meanAndStdDevData))
